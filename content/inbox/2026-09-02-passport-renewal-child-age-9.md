---
title: Passport renewal checklist — child, age 9
captured: 2026-09-02
type: checklist
---
...
- **Validity**: the new passport is valid for **5 years, or until the
  child turns 18 — whichever comes first**. There is no 10-year option at
  this age.
- **Police verification**: not required upfront for a standard minor
  reissue under 15 in most cases (it can occasionally happen
  post-issuance). Don't plan around needing it, but don't be surprised if
  CGI SF/VFS asks for it either.
